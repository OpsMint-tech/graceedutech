...
export default function Services() {
    const services = [
        ...
        },
        {
            ...
            description: "Comprehensive GST filing, Income Tax Return (ITR) filing, TDS return filing, and strategic tax planning to legally minimize tax liability.",
            icon: FileText
        },
        {
        ...
        },
        {
            ...
            description: "Comprehensive training on Amazon and Flipkart marketplace management, PPC advertising, and account health maintenance.",
            icon: Building2
        }
    ];
